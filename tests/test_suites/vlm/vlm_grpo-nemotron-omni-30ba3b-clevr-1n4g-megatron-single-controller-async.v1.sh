...
# Two steps exercise CP=1 multimodal generation, TQ policy training, weight
# refit, and a post-refit rollout without treating this smoke test as a
# convergence run. CP>1 + multimodal + TQ remains untested.
# ===== BEGIN CONFIG =====
NUM_NODES=1
GPUS_PER_NODE=4
STEPS_PER_RUN=2
