...
CONFIG="${CONFIG:-examples/nemo_gym/grpo_nemotron_omni_30ba3b_video_async.yaml}"
...
MEGATRON_CUDA_GRAPH_SCOPE="${MEGATRON_CUDA_GRAPH_SCOPE:-none}"
...
MOE_PAD_EXPERTS_FOR_CG="${MOE_PAD_EXPERTS_FOR_CG:-false}"
...
policy.is_vlm=true \
policy.tokenizer.video.num_frames=${NUM_FRAMES} \
