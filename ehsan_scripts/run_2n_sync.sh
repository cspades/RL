...
readonly SBATCH_ACCOUNT="${SBATCH_ACCOUNT:-nemotron_edge_omni}"
readonly SBATCH_PARTITION="${SBATCH_PARTITION:-interactive}"
...
export NRL_RUN_PREFIX="rl_main_vg2_sync_video_review_refactor_unlimited"
...
sbatch \
  ...
  --job-name=rl_main_vg2_sync_omni_video \
